...
while selection ~= "9" &&  selection ~= "quit"
    ...
    disp("3: Find a least squares solution (approximate sol. to overdetermined system)")
    ...
    while proceed ~= "Y" && proceed ~= "y"
        if proceed ~= ""
            disp("Please enter your matrix or matrices into the CSV file corresponding with the operation you want to run.")
            disp("Type 'Y' to proceed")
        end
        prompt = "";
